<div class="content">
    ...
    <div class="row">
        <div class="col-lg-9">
                ...
                <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3 pr-0">
                    <div class="dash-widget">
                        <span class="dash-widget-bg1">
                            <img src="<?php echo BASE_URL; ?>/public/admin/assets/img/icons/icon-1.png" alt="Icon"
                                width="25">
                        </span>
                ...
                <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3 pr-0">
                    <div class="dash-widget">
                        <span class="dash-widget-bg2"><img
                                src="<?php echo BASE_URL; ?>/public/admin/assets/img/icons/icon-3.png" alt="Icon"
                                width="25"></span>
                        <div class="dash-widget-info float-left pl-2">
                            <p>Total Staffs</p>
                            <h4>125</h4>
                ...
                <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3 pr-0">
                    <div class="dash-widget">
                        <span class="dash-widget-bg3"><img
                                src="<?php echo BASE_URL; ?>/public/admin/assets/img/icons/icon-2.png" alt="Icon"
                                width="25"></span>
                        <div class="dash-widget-info float-left pl-2">
                            <p>Total Rooms</p>
                            <h4>50</h4>
            ...
            <!--Patient statistics-->
            <h4 class="admin_title">PATIENT STATISTICS</h4>
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-8 ">
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center">
                            ...
                            <ul class="list-inline-item list-unstyled m-0">
                                <li class="list-inline-item expense"><i class="fas fa-circle"></i>&nbsp;&nbsp;Expenses
                                </li>
                                <li class="list-inline-item income"><i class="fas fa-circle"></i>&nbsp;&nbsp;Income</li>
                            </ul>
                        </div>
