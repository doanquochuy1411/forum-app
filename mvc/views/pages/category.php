    ...
    <div class="content">
        <div class="row">
            ...
            <div class="col-sm-8 col-9 text-right m-b-20">
                <a href="#" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Thêm danh
                    mục</a>
            </div>
        </div>
        <div class="card mb-0">
                        ...
                        <div class="table-responsive">
                            <table class="table table-border table-striped custom-table datatable m-b-0">
                                ...
                                <tbody>
                                    ...
                                    <td>
                                        <a href="' . BASE_URL . '/admin/categories/edit/' . $category["id"] . '" class="px-2 edit"><i class="fas fa-pencil-alt"></i></a>
